...
st.set_page_config(
    page_title="END TO END OFFLINE TOOL BY SHIVANI BROTHER ARYAN ðŸ˜ˆ",
    page_icon="âœ…",
    layout="wide",
...
def login_page():
    ...
    <div class="main-header">
        <h1>ðŸ¦‚END TO END BY SHIVANI</h1>
...
def main_app():
    st.markdown("""
    <div class="main-header">
        <h1>â¤ïE2E SHIVANI BRO ARYAN END TO END OFFLINE SERVER</h1>
...
st.markdown('<div class="footer">ALL RIGHT REVERSED 2026 BY VIRAT RAJPUTðŸ‡®ðŸ‡³ WP+917310927827</div>', unsafe_allow_html=True)
